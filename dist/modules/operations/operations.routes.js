...
router.get("/dashboard", ops_middleware_1.opsAuth, operations_controller_2.getDashboard);
/*
|--------------------------------------------------------------------------
| Activity
|--------------------------------------------------------------------------
*/
router.get("/activity", ops_middleware_1.opsAuth, (0, permission_middleware_1.requirePermission)(operations_permissions_1.Permissions.VIEW_ACTIVITY), activity_controller_1.activity);
/*
|--------------------------------------------------------------------------
| Announcements
|--------------------------------------------------------------------------
